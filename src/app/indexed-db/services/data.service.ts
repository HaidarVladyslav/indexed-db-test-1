...
import { EntityStateEnum } from '../enums/idb.enum';
import { ApiHandleService } from './http-service/api-handler.service';
...
export class DataService {
  ...
  async getListAsync(
    ...
    if (apiData?.status) {
      // if API call was successful and there is any data the add data to cache
